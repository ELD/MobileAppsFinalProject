        ...
        mGetMoviesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(leftSelectionIsMovie && rightSelectionIsMovie) {
                    mMoviePairList.setMoviePairList(
                            APIHandler.getMoviePairs(leftSelectedMovieOrGenre, rightSelectedMovieOrGenre)
                    );

                    Log.d(TAG, "onClick: " + mMoviePairList.getMoviePairs().size());
